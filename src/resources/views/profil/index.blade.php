<x-layouts.app>
    <main>
        ...
        <div class="bg-white justify-center">
            ...
            <div style="background-image: url('{{ asset('img/pp1.png') }}')"
                class="flex flex-col md:flex-row items-center justify-between  bg-cover bg-center bg-no-repeat rounded-[4rem] p-6 md:p-10 shadow-lg max-w-7xl mx-auto my-8">
            ...
            <div style="background-image: url('{{ asset('img/pp2.png') }}')"
                class="flex flex-col md:flex-row items-center justify-between  bg-cover bg-center bg-no-repeat rounded-[4rem] p-6 md:p-10 shadow-lg max-w-7xl mx-auto my-8">
                ...
                <div
                    ...
                    <div class="flex-shrink-0">
                        <div class="w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden bg-gray-200">
                            <img src="{{ asset($profile['foto']) }}" alt="{{ $profile['nama'] }}"
        ...
        <div
            class="w-[400px] h-[220px] rounded-3xl
        ...
        <div class="mt-4 md:mt-0 md:mr-6 text-center md:text-left">
            ...
            <p class="text-gray-600 mt-2">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt ut labore et
                dolore magna aliqua.
