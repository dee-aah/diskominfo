    ...
    <main>
        ...
        <div>
            <img class="absolute brightness-25  left-0 w-full h-full object-cover object-top z-0 transform-translate-y-5"
                src="{{ asset('img/cirahong.jpg') }}" alt="">
        </div>
            <!-- Overlay -->
        ...
        <div class="bg-stone-50 justify-center">
            <h2 class="text-center text-lg font-semibold text-gray-800 mb-2">
                Profil Pimpinan
            </h2>
            <p class="text-center text-sm text-gray-600 mb-8">
                Struktur organisasi ini menjadi landasan tata kerja dan koordinasi antar unit di lingkungan DPPKBP3A
                Kota Tasikmalaya dalam rangka mewujudkan pelayanan yang terarah, akuntabel, dan profesional.
            </p>
            <div
                class="flex flex-col md:flex-row items-center justify-between bg-[url('/pp1.png')] bg-cover bg-center bg-no-repeat rounded-[4rem] p-6 md:p-10 shadow-lg max-w-7xl mx-auto my-8">
                ...
                <div class="md:w-1/2 flex justify-end">
                    <img src="pp.png" alt="Foto Imin" class="w-66 h-auto rounded-[6rem]" />
                </div>
            </div>

            <div
                class="flex flex-col md:flex-row items-center justify-between  bg-[url('/pp3.png')] bg-cover bg-center bg-no-repeat rounded-[4rem] p-6 md:p-10 shadow-lg max-w-7xl mx-auto my-8">
                <div class="md:w-1/2 flex justify-start mb-6 md:mb-0">
                    <img src="pp2.png" alt="Foto Imin" class="w-66 h-auto rounded-[6rem]" />
                </div>
