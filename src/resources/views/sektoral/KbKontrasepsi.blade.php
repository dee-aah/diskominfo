<x-layouts.sideb>
    <body class="bg-gray-50 font-sans p-6">
        <div class="bg-white shadow-md rounded-lg mt-20 max-w-5xl mx-auto">
            ...
            <div class="border mb-6 rounded-lg">
                        ...
                        <table class="w-full border text-sm text-gray-700">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="border px-3 py-2">Metode Kontrasepsi</th>
                            ...
                            <tbody>
                                @foreach ($datakontrasepsi as $row)
                                    <tr>
                                        ...
                                        <td class="border text-justify px-2 py-1">{{ $row['metode_alat_kontrasepsi'] ?? '-' }}</td>
                ...
                <div id="contentGrafik" class="p-4  hidden">
                    <canvas id="kontrasepsiChart" height="120"></canvas>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            // Data untuk grafik
            const labels = @json($metodeList);
            const dataKasus = @json($totalPesertaPerMetode);
            // Buat grafik Chart.js
            new Chart(document.getElementById("kontrasepsiChart"), {
                type: 'line',
                data: {
                    labels: labels,
                    datasets: [{
                        label: "Peserta Keluarga Berencana Berdasarkan Alat Kontrasepsi",
                        data: dataKasus,
                        fill: true,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Jumlah Peserta Keluarga Berencana Berdasarkan Alat Kontrasepsi'
                        }
                    },
                    scales: {
                        y: {
