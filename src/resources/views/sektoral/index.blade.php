<x-layouts.app>
    ...
    <section class="max-w-6xl mx-auto  py-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            ...
            <div class="bg-[#2563EB] text-white p-6 rounded-xl shadow-md text-center">
                ...
                <div class="text-3xl font-bold mt-2">{{ number_format($datapemberdayaanterbaru, 2, ',', '.') }}</div>
            ...
            <div class="bg-[#43A047] text-white p-6 rounded-xl shadow-md text-center">
                ...
                <div class="text-3xl font-bold mt-2">{{ number_format($datakbterbaru, 0, ',', '.') }}</div>
            ...
            <div class="bg-[#8E24AA] text-white p-6 rounded-xl shadow-md text-center">
                ...
                <div class="text-3xl font-bold mt-2">{{ number_format($datasuburterbaru, 0, ',', '.') }}</div>
    ...
    <section class="flex max-w-6xl grid grid-cols-12 gap-5 my-5 mx-auto ">
        <aside class="col-span-3 text-center space-y-6">
                ...
                <ul class="space-y-2 " role="tablist">
                    <li>
                        <a href="#" data-tab-target="subur" role="tab" aria-selected="true"
                            aria-controls="subur" class="block bg-gray-200 px-3 py-2 rounded text-sm text-gray-700">
            ...
            <div class="bg-white shadow border border-gray-200 rounded-lg p-4">
                ...
                <ul class="space-y-2" role="tablist">
                    ...
                    <li>
                        <a href="#" data-tab-target="kbkontrasepsikecamatan"role="tab" aria-selected="false"
                            aria-controls="kbkontrasepsikecamatan"
                            class="block bg-gray-200 px-3 py-2 rounded text-sm text-gray-700">
        ...
        <main class="col-span-9 bg-white rounded-xl border border-gray-200 shadow p-6">
            ...
            <div id="keluargaberencanakecamatan" data-tab-content role="tabpanel"
                class="bg-white hidden max-w-5xl mx-auto">
                <!-- Judul -->
                <h1 class="text-center text-xl font-bold text-gray-800 mb-5">
                ...
                <div id="kbkontrasepsi" data-tab-content role="tabpanel" class="bg-white hidden  max-w-5xl mx-auto">
                    ...
                    <div class=" p-4 mb-6">
                        <p class="text-gray-700 text-sm leading-relaxed ">
                            ...
                            Dataset terkait topik Pengendalian Penduduk ini dihasilkan oleh Dinas Pengendalian Penduduk,
                            Keluarga Berencana,
                            Pemberdayaan Perempuan dan Perlindungan Anak Kota Tasikmalaya yang dikeluarkan dalam periode
                            1 tahun
                            sekali.
                        </p>
                    </div>
            ...
            <div id="kbkontrasepsikecamatan" data-tab-content role="tabpanel"
                class="bg-white  hidden max-w-5xl mx-auto">
                <!-- Judul -->
                <h1 class="text-center text-xl font-bold text-gray-800 mb-5">
                                ...
                                @foreach ($datakontrasepsi as $row)
                                    <tr class="text-center">
                                        ...
                                        <td class="border-2 border-gray-300 px-2 py-1">
                                            {{ $row['nama_kecamatan'] ?? '-' }}</td>
                                        <td class="border-2 border-gray-300 px-2 py-1">
                                            {{ number_format($row['jumlah_alat_kontrasepsi'] ?? '-', 0, ',', '.') }}
                                        </td>
                                        <td class="border-2 border-gray-300 px-2 py-1">{{ $row['satuan'] ?? '-' }}
                                        </td>
                                        <td class="border-2 border-gray-300 px-2 py-1">{{ $row['tahun'] ?? '-' }}</td>
