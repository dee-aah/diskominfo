<x-layouts.sideb>
    <body class="bg-gray-50 font-sans p-6">
                            ...
                            <tbody>
                                @foreach ($datapemberdayaan as $row)
                                    <tr>
                                        ...
                                        <td class="border text-justify px-2 py-1">{{ $row['indeks_pemberdayaan_gender'] ?? '-'}}</td>
        ...
        <script>
            ...
            const dataKasus = @json($indexpemberdayaan);
            ...
            new Chart(document.getElementById("indexChart"), {
                ...
                data: {
                    labels: labels,
                    datasets: [{
                        label: "Index Pemberdayaan Gender",
                        data: dataKasus,
                        fill: true,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Index Pemberdayaan Gender Kota Tasikmalaya Setiap Tahun'
                        }
                    },
                    scales: {
                        y: {
