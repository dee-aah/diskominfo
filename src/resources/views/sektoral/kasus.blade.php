<x-layouts.app>
  ...
  <div class="bg-white shadow-md rounded-lg mt-20 max-w-5xl mx-auto">
    ...
    <div class="border rounded-lg p-4 mb-6">
      ...
      <p class="text-gray-700 text-sm leading-relaxed mb-3">
        Dataset ini berisi data jumlah pasangan usia subur berdasarkan kecamatan di Kota Tasikmalaya dari tahun 2019 s.d. 2024.
        Dataset terkait topik Pengendalian Penduduk ini dihasilkan oleh Dinas Pengendalian Penduduk, Keluarga Berencana,
      ...
      <ul class="list-disc pl-6 text-sm text-gray-700 space-y-2">
        <li><b>kode_provinsi:</b> menyatakan kode Provinsi Jawa Barat sesuai ketentuan BPS merujuk pada aturan Peraturan Badan Pusat Statistik Nomor 3 Tahun 2019 dengan tipe data numerik.</li>
        <li><b>nama_provinsi:</b>menyatakan lingkup data berasal dari wilayah Provinsi Jawa Barat sesuai ketentuan BPS merujuk pada aturan Peraturan Badan Pusat Statistik Nomor 3 Tahun 2019 dengan tipe data teks.</li>
        <li><b>kode_kabupaten_kota:</b>menyatakan kode Kota Tasikmalaya sesuai ketentuan BPS merujuk pada Peraturan Badan Pusat Statistik Nomor 3 Tahun 2019 dengan tipe data numerik.</li>
        <li><b>nama_kabupaten_kota:</b> menyatakan lingkup data berasal dari wilayah Kota Tasikmalaya sesuai penamaan BPS merujuk pada Peraturan Badan Pusat Statistik Nomor 3 Tahun 2019 dengan tipe data teks.</li>
        <li><b>kode_kecamatan:</b>  menyatakan kode dari setiap kecamatan di Kota Tasikmalaya sesuai ketentuan BPS merujuk pada Peraturan Badan Pusat Statistik Nomor 3 Tahun 2019 dengan tipe data numerik.</li>
        <li><b>nama_kecamatan:</b> menyatakan lingkup data berasal dari setiap kecamatan di Kota Tasikmalaya sesuai penamaan BPS merujuk pada Peraturan Badan Pusat Statistik Nomor Nomor 3 Tahun 2019 dengan tipe data teks.</li>
        <li><b>jumlah_pasangan_usia_subur:</b> menyatakan jumlah pasangan usia subur dengan tipe data numerik.</li>
        <li><b>satuan:</b> menyatakan satuan dari pengukuran jumlah pasangan usia subur dalam orang dengan tipe data teks.</li>
    ...
    <div class="border rounded-lg">
      <div class="flex border-b">
        <button id="tabTabel" class="flex-1 text-center py-2 font-semibold text-blue-600 border-b-2 border-blue-600">Tabel</button>
  ...
  <script>
   ...
   // const target = [85,80,85,75,80,75,70,75,70];
    //const realisasi = [78,82,78,79,81,77,73,71,74];
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: 'Tren Kasus Kekerasan per Tahun'
        }
      },
      scales: {
        y: {
