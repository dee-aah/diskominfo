<x-layouts.sidebar>
    <div class="p-6 bg-blue-50">
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="toggleModal(true)" class="bg-blue-500 space-x-2 flex hover:bg-blue-600 text-white px-4 py-2 rounded">
            <i class="fa-solid fa-plus mr-3 mt-2"></i>   Tambah Berita
            </button>
        </div>
        ...
        <div id="modal" class="fixed inset-0 bg-green-50  bg-opacity-50 hidden items-center  justify-center z-50">
            <div class="bg-white  rounded-lg shadow-lg border-2 border-indigo-500 w-full my-8 max-w-180">
                <div class="flex justify-between  items-center m-4">
                    ...
                    <div>
                        <button onclick="toggleModal(false)" class="text-black hover:text-red-500 text-xl font-bold">&times;</button>
                    </div>

                </div>
                <form  class="mx-8 " action="{{ route('beritakita.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
