        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 relative">
            ...
            <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <input type="text" name="penulis" placeholder="Penulis" class="border p-2 rounded w-full"
                        required>
                    <input type="text" name="tag" placeholder="Tag (pisahkan dengan koma)"
            ...
            <button onclick="toggleModal(false)"
                class="absolute top-2 right-2 text-gray-600 hover:text-red-600 text-2xl leading-none">&times;</button>
        </div>
    </div>
