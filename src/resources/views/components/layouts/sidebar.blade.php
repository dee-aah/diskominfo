...
<div class="mx-auto mx-w-5xl">
    ...
    <nav class="bg-white border-b-1 border-gray-200 w-full fixed top-0 z-50">
        <div class="flex justify-between h-15 items-center px-4">
    ...
    <div class="flex font-Inter fixed my-15 min-h-screen">
        <!-- Sidebar -->
        <div id="sidebar"
            class="w-70  bg-white border-r-1  border-gray-200 flex flex-col space-y-6 py-7 px-4
            ...
            <ul class="mx-3">
                <li class="mb-2 w-55 rounded hover:bg-blue-100">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <a href="{{ route('pimpinan.dashboard') }}"
                            class="flex items-center font-medium p-2 text-gray-700 ">
                ...
                <li class="mb-2 w-55 rounded hover:bg-blue-100">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <a href="{{ route('tentang_kami.dashboard') }}"
                            class="flex font-medium items-center p-2 text-gray-700 ">
                ...
                <li class="mb-2">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <button
                            ...
                            onclick="toggleMenu('Menu4')">Profil Pimpinan
                        ...
                        <!-- Sub Menu -->
                        <ul id="Menu4" class="hidden ml-6 ">
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('profill.dashboard') }}"
                                    class="flex items-center font-medium p-2 text-gray-700 ">Pimpinan</a>
                            </li>
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('profil_cont.dashboard') }}"
                                    class="flex items-center font-medium p-2 text-gray-700 ">Profil
                                    Konten</a>
                            </li>
                        </ul>
                    @endif
                ...
                <li class="mb-2">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        ...
                        <!-- Sub Menu -->
                        <ul id="Menu1" class="hidden ml-6 ">
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('tupoksii.dashboard') }}"
                                    class="flex items-center font-medium p-2 text-gray-700 ">Tugas &
                                    Fungsi</a></li>
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('uraian.dashboard') }}"
                                    class="flex items-center font-medium p-2 text-gray-700 ">Uraian
                                    Tugas</a>
                            </li>
                        </ul>
                    @endif
                ...
                <li class="mb-2">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <button
                            class="flex items-center font-medium p-2 justify-between text-gray-700 rounded w-55 hover:bg-blue-100"
                            onclick="toggleMenu('Menu')">Informasi Layanan
                        ...
                        <!-- Sub Menu -->
                        <ul id="Menu" class="hidden ml-6 ">
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('layanan.dashboard') }}"
                                    class="flex font-medium items-center p-2 text-gray-700 ">Program &
                                    Layanan</a>
                            </li>
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('layanan_detail.dashboard') }}"
                                    class="flex font-medium items-center p-2 text-gray-700 ">Detail
                                    Layanan</a>
                            </li>
                        </ul>
                    @endif
                ...
                <li class="mb-2">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <button
                            class="flex items-center font-medium p-2 justify-between text-gray-700 rounded w-55 hover:bg-blue-100"
                            onclick="toggleMenu('Menu2')">Produk Hukum
                        ...
                        <!-- Sub Menu -->
                        <ul id="Menu2" class="hidden ml-6 ">
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('produk_hukum.dashboard') }}"
                                    class="flex font-medium items-center p-2 text-gray-700 ">Produk
                                    Hukum</a></li>
                            <li class="rounded hover:bg-blue-100"><a
                                    href="{{ route('produk_hukum_cont.dashboard') }}"
                                    class="flex font-medium items-center p-2 text-gray-700 ">Isi
                                    Konten</a>
                            </li>
                        </ul>
                    @endif
                ...
                <li class="mb-2">
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <button
                            class="flex font-medium items-center p-2 justify-between text-gray-700 rounded w-55 hover:bg-blue-100"
                            onclick="toggleMenu('Menu3')">Data Sektoral
                        ...
                        <!-- Sub Menu -->
                        <ul id="Menu3" class="hidden ml-6 ">
                            <li class="rounded hover:bg-blue-100"><a href="{{ route('sektorall.dashboard') }}"
                                    class="flex font-medium items-center p-2 text-gray-700 ">Konten
                                    Sektoral</a></li>
                ...
                <li class="mb-2 roundedw-55 hover:bg-blue-100">
                ...
                <li class="mb-2 rounded w-55 hover:bg-blue-100">
                    @if (auth()->check() && auth()->user()->role === 'user')
