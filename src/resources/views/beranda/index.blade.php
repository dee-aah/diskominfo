<x-layouts.app>
        ...
        <div class="min-h-screen flex max-w-6xl mx-auto items-center justify-center px-6 py-12 bg-white">
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="flex justify-center">
                    <img src="{{asset('storage/pimpinan/'. $pimpinan->gambar)}}" loading="lazy" alt="pimpinan" class="w-72 md:w-76 ">
                </div>
                <!-- Konten Teks Kanan -->
                <div>
  ...
  <div class="grid grid-cols-3 gap-6 auto-rows-[200px] ">
    ...
    <a href="sipek.html" class="bg-rose-100 p-6 rounded-lg shadow hover:shadow-lg transition relative col-span-2 cursor-pointer block">
      <h3 class="text-lg font-semibold mb-2">Standar Pelayanan (SISPEK)</h3>
      <p class="text-sm text-gray-700">
        DPPKBP3A Kota Tasikmalaya menyediakan layanan terkait pengendalian penduduk, keluarga berencana, pemberdayaan perempuan, serta perlindungan anak untuk mendukung kesejahteraan masyarakat.
      </p>
      <span class="absolute bottom-3 right-3 text-gray-600">↗</span>
    </a>

    <!-- Card 3: IKM -->
    <a href="ikm.html" class="bg-yellow-100 p-6 rounded-lg shadow hover:shadow-lg transition relative cursor-pointer block">
      <h3 class="text-lg font-semibold mb-2">IKM</h3>
      <p class="text-sm text-gray-700">
    ...
    <a href="statistik.html" class="bg-gray-100 p-6 rounded-lg shadow hover:shadow-lg transition relative cursor-pointer block">
