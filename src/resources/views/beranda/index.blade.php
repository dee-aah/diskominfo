    ...
    <!-- Konten Hero -->
        <div class="relative z-20 flex items-center justify-center min-h-screen text-center px-4 pt-8 pb-8">
            <div class="text-white max-w-2xl">
                <h1 id="typewriter" class="text-4xl md:text-5xl font-bold leading-normal mb-4 text-white whitespace-nowrap overflow-hidden typewriter"></h1>
                <p class="text-lg mb-6">Dinas Pengendalian Penduduk, Keluarga Berencana, Pemberdayaan Perempuan, dan Perlindungan Anak.</p>
                <a href="#container1" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full transition">Lihat Layanan Kami</a>
            </div>
        </div>
    <!-- Wave SVG -->
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      ...
      <div>
        ...
        <p class="text-base md:text-lg text-gray-700 mb-6 leading-relaxed">
         Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus distinctio sint ex cum minus explicabo aliquid dolorem doloribus porro fugit in, ipsam cupiditate esse! Inventore nulla nemo, pariatur magnam modi sequi sint in nam rem, iste ut? Iure accusantium suscipit ab architecto, exercitationem asperiores quisquam iste, odit esse assumenda rerum itaque vitae vel aliquam optio harum veritatis repudiandae earum aspernatur perferendis porro corrupti obcaecati? Inventore accusantium minima, nemo quas pariatur .
        </p>
       <a href="#" class="inline-flex items-center px-6 py-2 border border-black text-black rounded-full hover:bg-blue-100 hover:text-black transition">
            Selengkapnya
  ...
  <div class="relative w-full max-w-screen-xl flex items-center overflow-hidden">
    <div id="slideWrapper" class="flex space-x-6 transition-transform duration-500 ease-in-out">
      ...
      <div id="card-0" class="min-w-[300px] max-w-md p-6 rounded-lg shadow-lg">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi maxime repellendus perspiciatis iusto non ex, voluptatem ea excepturi distinctio dignissimos dolorem, placeat nostrum a atque facere rerum corporis hic cupiditate!</p>
      ...
      <div id="card-1" class="min-w-[300px] max-w-md p-6 rounded-lg shadow-lg">
        ...
        <div class="h-[2px] w-10 bg-white mb-4"></div>
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus aliquam officiis amet, fuga dolor sint nisi, aut quod at ad debitis dolores repellendus, in nesciunt sequi provident cumque explicabo quas?</p>
        <div class="mt-4 text-right text-xl">↗</div>
        </a>
      </div>
      ...
      <div id="card-2" class="min-w-[300px] max-w-md p-6 rounded-lg shadow-lg">
        ...
        <div class="h-[2px] w-10 bg-white mb-4"></div>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odit aut vero voluptatum cumque consectetur? Dicta vero deleniti accusamus eaque laboriosam vitae aut quos modi, nam ratione? Consectetur iste consequatur error.</p>
        <div class="mt-4 text-right text-xl">↗</div>
        </a>
      </div>
      <div id="card-2" class="min-w-[300px] max-w-md p-6 rounded-lg shadow-lg">
        ...
        <div class="h-[2px] w-10 bg-white mb-4"></div>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis iste consequatur ab voluptates, deleniti ipsa, dolores, quidem corrupti porro non consectetur. Esse, quas consequatur veniam laudantium temporibus nulla aperiam hic!</p>
        <div class="mt-4 text-right text-xl">↗</div>
        </a>
      </div>
      <div id="card-2" class="min-w-[300px] max-w-md p-6 rounded-lg shadow-lg">
        ...
        <div class="h-[2px] w-10 bg-white mb-4"></div>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vel mollitia repellat, earum ad at amet perferendis dolores sed totam molestiae illum assumenda ipsa consectetur voluptatum rem. Nesciunt sed culpa doloremque.</p>
        <div class="mt-4 text-right text-xl">↗</div>
        </a>
      </div>
...
<section class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
     ...
     <div class="p-5 ">
      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati, nobis ipsam molestias quaerat veritatis dolores at veniam tempore fugiat rerum nesciunt ex accusamus nam dolor vitae molestiae totam nostrum reprehenderit.
    </div>

    <!-- Kanan -->
    <div class="flex-shrink-0 l p-2">
      <a href="data.html" class="inline-flex items-center px-4 py-2 border border-gray-400 text-sm font-medium rounded-full hover:bg-[#476A9A] hover:text-white transition">
        Selengkapnya
     ...
     <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 md:space-x-6">
 ...
 <div class="text-center mb-6">
    ...
    <div class="h-1 w-16 bg-blue-500 mx-auto mt-2 rounded"></div>
    <p class="text-gray-600 mt-2 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia sit possimus adipisci vel, expedita a, veniam rem amet et quisquam sapiente, nisi reprehenderit! Quidem quod aliquid aspernatur perspiciatis perferendis repellat.</p>
  </div>
<section class="relative bg-cover bg-center min-h-screen flex items-center" style="background-image: url('bg.jpg');">
    <!-- Overlay gelap -->
    ...
    <div class="relative z-10 w-full px-6 md:px-16 lg:px-24">
      ...
      <div class="max-w-xl text-left text-white space-y-4">
        ...
        <p class="text-lg text-gray-200">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt eum laudantium velit vitae aliquam vel eius eaque, numquam voluptas aut odio delectus explicabo facere? Officiis nemo sequi cum quo? Cum, asperiores ratione. Delectus repudiandae tempore quis ipsa doloribus optio voluptatum, nihil recusandae dolorum cumque accusamus a, reprehenderit dicta eius mollitia sint eos totam fugit libero error. Adipisci sit culpa, quae iure eligendi assumenda a possimus at, cupiditate, dolores optio facilis recusandae corrupti deserunt eaque in temporibus!
        </p>
        <div class="flex flex-wrap gap-4 pt-4">
          <a href="#" class="inline-flex items-center px-6 py-2 border border-white text-white rounded-full hover:bg-white hover:text-black transition">
            Selengkapnya
            <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
            </svg>
          </a>
          <a href="profil.html" class="inline-flex items-center px-6 py-2 border border-white text-white rounded-full hover:bg-white hover:text-black transition">
      ...
      <div class="md:col-span-2 bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-4">
          ...
          <p class="text-sm text-gray-600 mb-4">
            DPPKBP3A berhasil meraih penghargaan dari Kementerian Pemberdayaan Perempuan dan Perlindungan Anak atas program unggulan pemberdayaan perempuan di sektor UMKM.
          </p>
          <div class="flex justify-between items-center text-sm text-gray-500 mb-4">
            <div class="flex items-center gap-1">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3M3 11h18M5 19h14M12 15v2" />
              </svg>
              <span>15 Januari 2024</span>
            </div>
            <div class="flex items-center gap-1">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5.121 17.804A10.002 10.002 0 0112 2a10 10 0 016.879 15.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span>Admin DPPKBP3A</span>
            </div>
          </div>
          <a href="#" class="inline-flex items-center justify-center w-full px-6 py-2 bg-[#476A9A] text-white text-sm rounded hover:bg-blue-800 transition">
            Baca Selengkapnya
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white rounded-lg shadow p-4">
          ...
          <p class="text-sm text-gray-600 mb-2">
            Workshop edukasi untuk orang tua dan pendidik mengenai cara melindungi anak dari bahaya digital dan cyber bullying.
          </p>
          <a href="#" class="text-blue-700 text-sm inline-flex items-center gap-1 hover:underline">
            Baca Selengkapnya <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
            </svg>
          </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
          ...
          <p class="text-sm text-gray-600 mb-2">
            Indeks Kepuasan Masyarakat terhadap pelayanan DPPKBP3A mencapai 89.5%, meningkat 5% dari triwulan sebelumnya.
          </p>
          <a href="#" class="text-blue-700 text-sm inline-flex items-center gap-1 hover:underline">
            Baca Selengkapnya <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
        ...
        <div class="bg-white rounded-lg shadow p-4 text-center">
          <p class="text-sm text-gray-700 mb-3">Ikuti terus informasi dan program terbaru dari DPPKBP3A</p>
          <a href="#" class="inline-flex items-center justify-center px-6 py-2 bg-[#476A9A] text-white rounded hover:bg-blue-800 transition">
            Lihat Semua Berita
            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
            </svg>
