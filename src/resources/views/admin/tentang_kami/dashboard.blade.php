            ...
            <div id="main-content" class="p-5 border-t border-gray-200 sm:p-6">
                <div class="overflow-hidden rounded border  border-gray-200 bg-white pb-3  ">
                    <div class="w-full overflow-x-auto">
                        ...
                        <table class="table-auto w-full wrapper min-w-full text-sm">
                            <thead>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($tentangs as $tentang)
                                    <tr class="text-center mx-3 items-center hover:bg-gray-100">
                                        <td class=" px-3 border-r  border-gray-200 py-3 text-center">
                                            @if ($tentang->img)
                                                <img src="{{ asset('storage/tentang/' . $tentang->img) }}"
                                        ...
                                        <td class=" px-3 border-r  border-gray-200 py-3">
                                            {{ $tentang->created_at->translatedFormat('l d F Y.') }}</td>
                                        <td class="p-3  align-middle relative z-10">
                                            <el-dropdown class="inline-block">
                                                ...
                                                <el-menu anchor="bottom end" popover
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{ route('tentang_kami.show', $tentang) }}"
                                                        ...
                                                        <a href="{{ route('tentang_kami.edit', $tentang) }}"
                                                            class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class=" px-3 text-center py-3">Belum ada Tentang kami</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
