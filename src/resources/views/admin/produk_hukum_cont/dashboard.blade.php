        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium">Daftar Konten Produk Hukum</h2>
                </div>
                <div class="col-span-2 flex py-5 justify-end">
                    <form action="{{ route('produk_hukum_cont.dashboard') }}" method="GET"
                        ...
                        <a href="{{ route('produk_hukum_cont.create') }}" type="button"
                        ...
                        <table id="wrapper" class="table-auto wrapper min-w-full text-sm">
                            <thead class="border-b border-gray-200">
                                <tr class="border-gray-200 border-b ">
                                    ...
                                    <th class="font-medium border-r  border-gray-200 p-3">Gambar Konten</th>
                                    <th class="font-medium border-r  border-gray-200 p-3">Gambar PDF</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($produks as $produk)
                                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                                        <td class="p-3 border-r  border-gray-200">{{ $produk->deskripsi }}</td>
                                        <td class="p-3 border-r  border-gray-200 text-center">
                                            @if ($produk->img_cont)
                                                <img src="{{ asset('storage/produkimg/' . $produk->img_cont) }}"
                                        ...
                                        <td class="p-3 border-r  border-gray-200 text-center">
                                            @if ($produk->img_pdf)
                                                <img src="{{ asset('storage/produkimg/' . $produk->img_pdf) }}"
                                                    class="w-16 h-16 object-cover mx-auto justify-content-center rounded">
                                            @else
                                                -
                                            @endif
                                        ...
                                        <td class="p-3  align-middle ">
                                          <div class="flex justify-center items-center gap-1">
                                            <a href="{{ route('produk_hukum_cont.edit', $produk->id) }}"
                                                class=" col-span-2  p-3  ">
                                                <i class="fa-solid fa-pen text-gray-600 hover:text-yellow-500 cursor-pointer"></i>
                                            </a>
                                            <form action="{{ route('produk_hukum_cont.destroy', $produk->id) }}"
                                                method="POST"
                                                onsubmit="return confirm(' Anda Yakin Ingin Menghapus Konten ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class=" col-span-2 p-3  ">
                                                    <i class="fa-solid fa-trash text-gray-600 hover:text-red-500 cursor-pointer">
                                                    </i>
                                                </button>
                                            </form>
                                          </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-3">Belum ada Struktur Organisasi</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
