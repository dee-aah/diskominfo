                    ...
                    <div  class="w-full overflow-x-auto">
                        <table  class="table-auto w-full min-w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200 ">
                                @forelse ($pimpinans as $pimpinan)
                                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                                        <td class="px-3 border-r  border-gray-200 text-center py-3">
                                            @if ($pimpinan->img)
                                                <img src="{{ asset('storage/pimpinan/' . $pimpinan->img) }}"
                                        ...
                                        <td class="px-3 border-r  border-gray-200 py-3">{{ $pimpinan->created_at->translatedFormat('l d F Y.') }}
                                        </td>
                                        <td class="p-3  align-middle relative z-10">
                                            <el-dropdown class="inline-block">
                                                ...
                                                <el-menu anchor="bottom end" popover
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{ route('pimpinan.show', $pimpinan) }}"
                                                        ...
                                                        <a href="{{ route('pimpinan.edit', $pimpinan) }}"
                                                            class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center p-3">Belum ada sambutan Pimpinan</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
