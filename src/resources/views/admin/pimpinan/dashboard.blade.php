            ...
            <tbody class="bg-gray-100">
                @forelse ($pimpinans as $pimpinan)
                    <tr class="text-center items-center ">
                        ...
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $pimpinan->deskripsi }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center border border-gray-400 border-2 py-4">Belum ada sambutan Pimpinan</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
