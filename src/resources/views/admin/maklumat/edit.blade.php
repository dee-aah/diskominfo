        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Maklumat</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('maklumat.update', $maklumat) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="my-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input  type="file" name="img"
                            ...
                            <img src="{{ asset('storage/maklumat1/' . $maklumat->img) }}" class="w-32 mt-1 rounded">
                        @endif
                    </div>
