    ...
    <div class="p-6">
        <div class="flex justify-between grid grid-cols-3 items-center mb-4">
            <div class="justify-start col-1">
                <h2 class="text-2xl  font-bold">Daftar Maklumat</h2>
            </div>
            <div class="col-span-2 flex justify-end">
                <form action="{{ route('maklumat.dashboard') }}" method="GET" class="flex justify-end  mr-2">
                    <input type="text" name="d" value="{{ request('d') }}" placeholder="Cari Maklumat..."
            ...
            <tbody class="bg-gray-100">
                @forelse ($maklumats as $maklumat)
                    <tr class="text-center items-center ">
                        ...
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $maklumat->deskripsi }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center border border-gray-400 border-2 py-4">Belum ada Maklumat</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
