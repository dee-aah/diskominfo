        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Program dan Layanan</h3>
                </div>
            </div>
                ...
                <div class="overflow-hidden rounded border  border-gray-300 px-6 bg-white pb-8   ">
                    <form action="{{ route('layanan.update', $layanan->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="program"
                                    ...
                                    @foreach ($jenisOptions as $option)
                                        <option value="{{ $option }}"
                                            {{ old('program', $layanan->program ?? '') == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" rows="12" placeholder="Masukkan Deskripsi Program"
