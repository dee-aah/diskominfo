        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium">Daftar Konten Data Sektoral Card</h2>
                </div>
                <div class="col-span-2 flex py-5 justify-end">
                    <form action="{{ route('sektoral_cont.dashboard') }}" method="GET"
                        ...
                        <a href="{{ route('sektoral_cont.create') }}" type="button"
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($sektorals as $sektoral)
                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                        <td class="p-3 border-r  border-gray-200">{{ $sektoral->nama }}</td>
                        <td class="p-3 border-r  border-gray-200 text-center">
                            @if ($sektoral->gambar)
                                <img src="{{ asset('storage/sektoral_cont/' . $sektoral->gambar) }}"
                        ...
                        <td class="p-3  align-middle ">
                            ...
                            <a href="{{ route('sektoral_cont.edit', $sektoral->id) }}"
                                class=" col-span-2  p-3  ">
                                                <i
                                                    class="fa-solid fa-pen text-gray-600 hover:text-yellow-500 cursor-pointer"></i>
                            </a>
                            <form action="{{ route('sektoral_cont.destroy', $sektoral->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    class=" col-span-2 p-3  ">
                                                    <i
                                                        class="fa-solid fa-trash text-gray-600 hover:text-red-500 cursor-pointer"></i>
                                </button>
                            </form>
                                    </div>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="p-3">Belum ada Konten</td>
                    </tr>
                @endforelse
            </tbody>
        </div>
