...
<div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium">Konten </h2>
                </div>
                <div class="col-span-2 flex py-5 justify-end">
                    <form action="{{ route('konten.dashboard') }}" method="GET" class="flex justify-end  mr-2">
                    ...
                    <a href="{{ route('konten.create') }}" type="button"
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($kontens as $konten)
                    <tr class="text-center mx-3 items-center hover:bg-gray-100">
                        ...
                        <td class="p-3 border-r  border-gray-200">{{$konten->nama}}</td>
                        <td class="px-3 border-r  border-gray-200 py-3">{{ $konten->created_at->translatedFormat('l d F Y.') }}</td>
                                            ...
                                            <el-dropdown class="inline-block">
                                                ...
                                                <el-menu anchor="bottom end" popover
                                                    ...
                                                    <div class="py-1">
                                                        ...
                                                        <form action="{{ route('konten.destroy', $konten) }}"
                                                            method="POST"
                ...
                @empty
                    <tr>
                        <td colspan="5" class="p-3 text-center">Belum ada Konten</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
