            ...
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('konten.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" placeholder=" Masukkan Deskripsi Konten"
                            class="w-full border editor border-gray-300 placeholder:text-sm text-sm rounded-lg p-2"></textarea>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('konten.dashboard') }}" type="button"
