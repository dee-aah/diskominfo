            ...
            <div class="max-w-3xl mx-auto ">
                ...
                <form action="{{ route('program.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" placeholder=" Masukkan Nama Program"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" rows="5" placeholder=" Masukkan Deskripsi Program"
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('program.dashboard') }}" type="button"
