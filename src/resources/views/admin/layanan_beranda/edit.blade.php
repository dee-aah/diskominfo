        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Layanan Beranda</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('layanan_beranda.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="block py-2 text-[15px] text-black font-medium">Link Dokumen</label>
                        <input type="text" name="link" value="{{ old('link', $layanan->link) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="deskripsi"
                            placeholder="Masukkan DeskripsiLayanan"
                            class="w-full border editor border-gray-300 placeholder:text-sm text-sm rounded-lg p-2" required>{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('layanan_beranda.dashboard') }}"
