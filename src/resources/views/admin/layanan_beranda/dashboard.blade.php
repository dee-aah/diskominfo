...
<div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium"> Layanan Beranda </h2>
                </div>
                <div class="col-span-2 flex py-5 justify-end">
                    <form action="{{ route('layanan_beranda.dashboard') }}" method="GET" class="flex justify-end  mr-2">
                    ...
                    <a href="{{ route('layanan_beranda.create') }}" type="button"
            ...
            <thead class="border-b border-gray-200">
                    <th class="font-medium border-r  border-gray-200 p-3">Nama Layanan</th>
                    <th class="font-medium border-r  border-gray-200 p-3">Link </th>
                    <th class="font-medium border-r  border-gray-200 p-3">Deskripsi Layanan</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($layanans as $layanan)
                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                        ...
                        <td class="p-3 border-r  border-gray-200">{{ $layanan->link }}</td>
                        <td class="p-3 border-r  border-gray-200">{{ $layanan->deskripsi}}</td>
                        <td class="p-3  align-middle ">
                            <div class="flex justify-center items-center gap-1">
                            <a href="{{ route('layanan_beranda.edit', $layanan->id) }}"
                                class="  p-3  ">
                                    <i class="fa-solid fa-pen text-gray-600 hover:text-yellow-500 cursor-pointer"></i>
                            </a>
                            <form action="{{ route('layanan_beranda.destroy', $layanan->id) }}" method="POST"
                ...
                @empty
                    <tr>
                        <td colspan="9" class="p-3 mt-3 text-center">Belum ada Layanan</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
