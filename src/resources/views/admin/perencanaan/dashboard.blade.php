                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($perencanaans as $perencanaan)
                                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                                        ...
                                        <td class="p-3 border-r  border-gray-200">{{ $perencanaan->created_at->translatedFormat('l d F Y.') }}</td>
                                        <td class="p-3  align-middle relative z-10">
                                            <el-dropdown class="inline-block">
                                                ...
                                                <el-menu anchor="bottom end" popover
                                                    ...
                                                    <div class="py-1">
                                                        <a href="{{ route('perencanaan.show', $perencanaan) }}"
                                                        ...
                                                        <a href="{{ route('perencanaan.edit', $perencanaan) }}"
                                                            class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">
                                                            <i class="fa-solid fa-pen text-gray-600 px-3"></i> Edit
                                                        </a>
                                                        <form action="{{ route('perencanaan.destroy', $perencanaan) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Yakin hapus Dokumen Perencanaan ini?')">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
