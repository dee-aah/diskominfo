    ...
    <div class="p-6">
        <div class="flex justify-between grid grid-cols-3 items-center mb-4">
            <div class="justify-start col-1">
                <h2 class="text-2xl  font-bold">Daftar Tupoksi</h2>
            </div>
        ...
        <table class="w-full table-auto border-gray-400 border-2 border text-sm">
            <thead>
                <tr class="bg-slate-300 text-center">
                    ...
                    <th class="px-4 border border-gray-400 border-2 py-2">Tugas Utama</th>
                    <th class="px-4 border border-gray-400 border-2 py-2">Fungsi Utama</th>
            ...
            <tbody class="bg-gray-100">
                @forelse ($tupoksis as $tupoksi)
                    <tr class="text-center items-center ">
                        ...
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $tupoksi->des_singkat }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $tupoksi->tugas_utama }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $tupoksi->fungsi_utama }}</td>
