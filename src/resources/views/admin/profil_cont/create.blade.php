        ...
        <div class="@container">
            <div class="max-w-3xl mx-auto ">
                <div class="flex justify-center items-center mb-4">
                    <h3 class="text-3xl text-center font-bold">Tambah Profil Konten</h3>
                </div>
                <form action="{{ route('profil_cont.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('profil_cont.dashboard') }}" type="button"
