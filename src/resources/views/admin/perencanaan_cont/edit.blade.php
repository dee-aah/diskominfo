        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Konten Dokumen Perencanaan</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('perencanaan_cont.update', $perencanaan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="my-3">
                        <label class="block py-2 text-[15px] text-black font-medium">Deskripsi Singkat</label>
                        <textarea name="des_singkat"
                    ...
                    <div class="my-3">
                        ...
                        <input  type="file" name="img_konten"
                            ...
                            <img src="{{ asset('storage/perencanaancont/' . $perencanaan->img_konten) }}" class="w-32 mt-1 rounded">
                        @endif
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('perencanaan_cont.dashboard') }}"
