...
<div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium"> Konten Dokumen Perencanaan </h2>
                </div>
                <div class="col-span-2 flex py-5 justify-end">
                    <form action="{{ route('perencanaan_cont.dashboard') }}" method="GET" class="flex justify-end  mr-2">
                    ...
                    <a href="{{ route('perencanaan_cont.create') }}" type="button"
                    ...
                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                        ...
                        <td class="p-3 border-r  border-gray-200 text-center">
                            @if ($perencanaan->img_konten)
                                <img src="{{ asset('storage/perencanaancont/' . $perencanaan->img_konten) }}"
                        ...
                        <td class="p-3  align-middle ">
                            ...
                            <a href="{{ route('perencanaan_cont.edit', $perencanaan->id) }}"
                                class="  p-3  ">
                                    <i class="fa-solid fa-pen text-gray-600 hover:text-yellow-500 cursor-pointer"></i>
                            </a>
                            <form action="{{ route('perencanaan_cont.destroy', $perencanaan->id) }}" method="POST"
