        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Dokumen Evaluasi</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('evaluasi.update', $evaluasi->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $evaluasi->nama) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="link" value="{{ old('link', $evaluasi->link) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input  type="file" name="img_pdf"
                            ...
                            <img src="{{ asset('storage/evaluasi/' . $evaluasi->img_pdf) }}" class="w-32 mt-1 rounded">
                        @endif
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('evaluasi.dashboard') }}"
