        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Tambah Dokumen Evaluasi</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('evaluasi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="nama" placeholder=" Masukkan Nama Dokumen"
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="link" placeholder=" Masukkan Link Dokumen"
                            class="w-full border  border-gray-300 placeholder:text-sm text-sm rounded-lg p-2" required>
                    </div>
                    </div>
                    <div class="mb-3 mt-2">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('evaluasi.dashboard') }}" type="button"
