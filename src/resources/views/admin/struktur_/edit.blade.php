    ...
    <main>
            <div class="max-w-3xl mx-auto">
                <div class="flex justify-center items-center mb-4">
                    <h3 class="text-3xl text-center font-bold">Edit Struktur Organisasi</h3>
                </div>
                <form action="{{ route('struktur_.update', $struktur->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" rows="5"
                            ...
                            class="w-full border bg-gray-100 border-gray-400 border-2 rounded p-2" required>{{ old('deskripsi', $struktur->deskripsi) }}</textarea>
                    </div>
                    <div class="flex ">
                        <div class="mb-3">
