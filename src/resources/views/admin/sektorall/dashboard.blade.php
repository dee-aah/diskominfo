        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex justify-between px-3 grid grid-cols-3 items-center ">
                <div class="justify-start ml-4 col-1">
                    <h2 class="text-xl  font-medium">Daftar Konten Data Sektoral</h2>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($sektorals as $sektoral)
                                    <tr class="text-center mx-3 items-center hover:bg-gray-100 ">
                                        <td class="p-3 border-r  border-gray-200 ">{{ Str::limit(strip_tags($sektoral->deskripsi), 100) }}</td>
                                    ...
                                    <div class="flex justify-center items-center gap-1">
                                            ...
                                            <form action="{{ route('sektorall.destroy', $sektoral->id) }}"
                                                method="POST"
