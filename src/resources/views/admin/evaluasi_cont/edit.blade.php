        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Edit Konten Dokumen Evaluasi</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('evaluasi_cont.update', $evaluasi->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="my-3">
                        ...
                        <textarea name="des_singkat"
                            ...
                            class="w-full border editor  border-gray-300 placeholder:text-sm text-sm rounded-lg p-2" required>{{ old('des_singkat', $evaluasi->des_singkat) }}</textarea>
                    </div>
                    <div class="my-3">
                        ...
                        <input  type="file" name="img_konten"
                            ...
                            <img src="{{ asset('storage/evaluasicont/' . $evaluasi->img_konten) }}" class="w-32 mt-1 rounded">
                        @endif
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('evaluasi_cont.dashboard') }}"
