        ...
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            <div class="flex  p-4 justify-center items-center ">
                <div class="flex  items-center ">
                    <h3 class="text-2xl text-center font-medium">Tambah Konten Dokumen Evaluasi</h3>
                </div>
            </div>
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('evaluasi_cont.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="my-3">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <a href="{{ route('evaluasi_cont.dashboard') }}" type="button"
