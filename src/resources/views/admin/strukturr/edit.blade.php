    ...
    <div class="max-w-5xl mx-auto  min-h-screen ml-2">
        <div class="rounded-2xl border  border-gray-200 bg-white ">
            ...
            <div id="main-content" class="p-5 border-t border-gray-300 sm:p-6 ">
                ...
                <form action="{{ route('strukturr.update', $struktur->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi"
                            ...
                            class="w-full border editor border-gray-300 placeholder:text-sm text-sm rounded-lg p-2" required>{{ old('deskripsi', $struktur->deskripsi) }}</textarea>
                    </div>
                        <div class="mb-3">
                        ...
                        <input  type="file" name="img"
                            ...
                            <img src="{{ asset('storage/struktur/' . $struktur->img) }}" class="w-32 mt-1  rounded">
                        @endif
                    </div>
