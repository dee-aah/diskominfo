            ...
            <tbody class="bg-gray-100">
                @forelse ($artikels as $artikel)
                    <tr class="text-center items-center ">
                        ...
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $artikel->judul }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $artikel->penulis }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $artikel->deskripsi }}</td>
                        <td class="px-4 border border-gray-400 border-2py-2">{{ $artikel->kategori_id }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $artikel->tag ?? '-' }}</td>
                        <td class="px-4 border border-gray-400 border-2 py-2">{{ $artikel->slug }}</td>
