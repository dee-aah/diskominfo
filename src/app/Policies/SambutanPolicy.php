...
class SambutanPolicy
{
     ...
     */
    public function update(User $user, SambutanPimpinan $pimpinan): bool
    {
        return $user->id === $pimpinan->user_id;
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, SambutanPimpinan $pimpinan): bool
    {
        return $user->id === $pimpinan->user_id;
    }
